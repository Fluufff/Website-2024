...
Convention staff reserves the right to determine whether any clothing and/or accessories contravene the following rules. Questions regarding rules for clothing and outfits should be directed to the head of Stewards & Safety, who can be contacted at [stewards@fluufff.org](mailto:stewards@fluufff.org).
